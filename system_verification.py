...
class SystemVerifier:
    ...
    def verify_phase_1(self):
        ...
        self.check_syntax("layers/ai_adapter.py", "AIAdapter syntax")
        self.check_syntax("layers/g_layer_academic_generator.py", "G-Layer syntax")
    ...
    def verify_phase_2(self):
        ...
        print("Checking core files...")
        self.check_file_exists("batch_controller.py", "Batch Process Controller")

        print("\nChecking Python syntax...")
        self.check_syntax("batch_controller.py", "Batch Controller syntax")
    ...
    def verify_phase_3(self):
        ...
        print("\nChecking Python syntax...")
        self.check_syntax("layers/w_layer_cross_paper_analysis.py", "W-Layer syntax")
        self.check_syntax("volume_indexer.py", "Volume Indexer syntax")
