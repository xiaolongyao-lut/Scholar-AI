...
|--------------|----------|-------------------------------|
| API Keys | `OPENAI_API_KEY=<OPENAI_API_KEY>`, `GITHUB_TOKEN=<GITHUB_TOKEN>` | `[A-Z_]+(?:KEY|TOKEN|SECRET)=[^\s]+` |
...
| Private Keys | `<PRIVATE_KEY_HEADER>`, `<RSA_PRIVATE_KEY_HEADER>` | `-----BEGIN [A-Z ]+PRIVATE KEY-----` |
...
2. **Alert the user:**
   ...
   Pattern: API_KEY=<OPENAI_API_KEY>
