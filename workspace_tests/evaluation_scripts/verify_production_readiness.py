...
def main():
    ...
    results.append(run_command(
        ...
        "python -m py_compile literature_assistant/core/python_adapter_server.py literature_assistant/core/recovery_console.py literature_assistant/core/recovery_execution_engine.py literature_assistant/core/memory_fact_store.py"
    ))
    ...
    results.append(run_command(
        ...
        "python -m pytest tests/legacy_root/test_adapter_import.py -q"
    ))
    ...
    results.append(run_command(
        ...
        "python -m pytest tests/legacy_root/test_recovery_api_routes_real.py -v --tb=short",
        show_output=True
    ))
