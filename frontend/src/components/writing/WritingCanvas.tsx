...
export function WritingCanvas({
  ...
  const connectionBadge = {
    online: { label: t('writing.canvas.online'), className: 'bg-emerald-100 text-emerald-700' },
    degraded: { label: t('writing.canvas.degraded'), className: 'bg-amber-100 text-amber-700' },
    offline: { label: t('writing.canvas.offline'), className: 'bg-rose-100 text-rose-700' },
  }[connectionState];
