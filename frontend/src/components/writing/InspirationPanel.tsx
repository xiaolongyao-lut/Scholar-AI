...
const sparkTypeConfig: Record<string, { icon: React.ElementType; label: string; color: string }> = {
  causal_extension: { icon: GitBranch, label: '因果延伸', color: 'text-blue-600 bg-blue-50 border-blue-200' },
  conflict:         { icon: AlertTriangle, label: '矛盾碰撞', color: 'text-amber-600 bg-amber-50 border-amber-200' },
  analogy:          { icon: RefreshCw, label: '类比迁移', color: 'text-violet-600 bg-violet-50 border-violet-200' },
  gap:              { icon: Target, label: '空白发现', color: 'text-rose-600 bg-rose-50 border-rose-200' },
  synthesis:        { icon: Sparkles, label: '多源综合', color: 'text-emerald-600 bg-emerald-50 border-emerald-200' },
