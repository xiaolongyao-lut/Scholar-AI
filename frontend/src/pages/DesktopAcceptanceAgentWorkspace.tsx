...
const ACCEPTANCE_WORKSPACE_STATE = {
  ...
  knowledge_actual_loading_gate: {
    ...
    provider_preflight_status: 'pending',
    provider_latest_status: 'unknown',
    ...
    recovery_blocked_by: ['provider_preflight:pending:unknown', 'live_smoke_artifact:missing'],
    ...
    next_safe_local_actions: ['Require provider_preflight.status=proved before running live context-receipt smoke.'],
  ...
  items: [
    {
      ...
      metadata: {},
      schema_version: 2,
      item_revision: 'review-acceptance-revision-1',
      target: null,
    ...
    },
    {
      ...
      schema_version: 2,
      item_revision: 'desktop-import-review-revision-1',
      target: null,
      promotion_intent: null,
